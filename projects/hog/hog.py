...
def roll_dice(num_rolls, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    scores = 0
    flag = 1 # flag 0 represent that there is zero in the outcome of the dice roll
    while num_rolls > 0:
        now = dice()
        if now == 1:
            flag = 0
        scores += now
        num_rolls -= 1
    return scores if flag == 1 else 1
    # END PROBLEM 1
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who == 0:
            increases = score0 - last_score
            if increases > running_high:
                running_high_tmp = increases
                print(running_high_tmp, 'point(s)! The most yet for Player 0')
            last_score_tmp = score0
        else:
            increases = score1 - last_score
            if increases > running_high:
                running_high_tmp = increases
                print(running_high_tmp, 'point(s)! The most yet for Player 1')    
